...
export class AuthService {
  ...
  private async logAudit(userId: string, action: string, details?: string, ipAddress?: string, userAgent?: string): Promise<void> {
  ...
  async register(registerDto: RegisterDto) {
    ...
    await this.logAudit(savedUser.userId, 'register', `Registered as ${accountType}`);
  }
